window.addEventListener("load", function () {
    ...
    const fotoProductoInput = document.getElementById("foto_perfil");
    const fotoError = document.getElementById("fotoError");

    const form = document.getElementById("crear-form"); // Obtén el formulario
    ...
    fotoProductoInput.addEventListener('blur', () => validarFotoProducto(fotoProductoInput, fotoError));
